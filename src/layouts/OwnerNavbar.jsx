    ...
    <nav className="bg-white shadow-sm fixed top-0 left-0 w-full z-50">
      <div className="max-w-7xl mx-auto px-4 py-2 flex justify-between items-center h-14 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-sm text-gray-700">Hi, Owner</span>
        </div>

        <div className="hidden md:flex items-center space-x-4">
          <NavItem to="/owner/dashboard">Dashboard</NavItem>
          <NavItem to="/owner/change-password">Change Password</NavItem>
          <button
